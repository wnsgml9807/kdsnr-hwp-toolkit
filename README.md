...
```bash
pip install https://github.com/wnsgml9807/kdsnr-hwp-toolkit/releases/download/v0.2.0/kdsnr_hwp_toolkit-0.2.0-cp310-abi3-win_amd64.whl
```

**macOS (Apple Silicon)**

```bash
pip install https://github.com/wnsgml9807/kdsnr-hwp-toolkit/releases/download/v0.2.0/kdsnr_hwp_toolkit-0.2.0-cp310-abi3-macosx_11_0_arm64.whl
```

**Linux (x64)** — 한컴 오피스가 없어 글꼴 자동 수집이 안 되므로 [폰트](#폰트) 파일을 수동으로 복사해야 합니다.

```bash
pip install https://github.com/wnsgml9807/kdsnr-hwp-toolkit/releases/download/v0.2.0/kdsnr_hwp_toolkit-0.2.0-cp310-abi3-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
```
