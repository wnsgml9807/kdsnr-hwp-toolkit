...
/// HWPX `borderFillIDRef` uses the same 1-based IDs that the renderer expects.
/// Keep invalid/legacy 0 as 0.
pub fn parse_border_fill_ref(attr: &quick_xml::events::attributes::Attribute) -> u16 {
    parse_u16(attr)
}
