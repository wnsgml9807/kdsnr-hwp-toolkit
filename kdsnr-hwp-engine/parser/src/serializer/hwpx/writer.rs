...
//!
//! 규칙:
//! - `mimetype`은 ZIP 최초 엔트리, STORED(무압축), extra field 없음 (OCF 규격)
//! - `version.xml`, `Preview/PrvImage.png`, jpeg/png BinData는 STORED로 둔다.
//! - bmp/tmp BinData는 한컴 native HWPX와 같이 DEFLATED로 둔다.
//! - XML 본문/메타 파일은 DEFLATED
